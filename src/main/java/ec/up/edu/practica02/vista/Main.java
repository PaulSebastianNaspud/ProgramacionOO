        ...
        do { //bucle do-while con condicion falso de int = 7 para salir del bucle
            ...
            switch (opcion) {
                case 1:  //caso1 Ingresar Cantante
                    ...
                    //create cantante en la lista personas
                ...
                case 2:
                    ...
                    compositor.calcularSalario(); // llamar al metodo calcularSalario
                ...
                case 3:
                    ...
                    System.out.println("Ingresar el codigo del cantante a agregar: ");//dato por teclado
                    codigo = entrada.nextInt();
                    /*
                      llamar al metodo buscarPorCodigoCantante, que devulve persona, a persona se hace un dowCasting
                      para ingesar un cantente como argumento del metodo agregarCliente
                    */
                    ...
                    codigo = entrada.nextInt();
                    /*
                      llamar al metodo buscarPorCodigoCompositor, que devulve persona, a persona se hace un dowCasting
                      para accder a su metodo de agregarCliente
                    */
                    Compositor compositorCasting = (Compositor) controladorPerCast.buscarPorCodigoCompositor(codigo);
                    //if para constar objetos que sean instancias de los datos que ingreso el usuario y evitar posibles falllos
                    ...
                    break;
                case 4:
                    controladorPerCast.imprimir();//imprimir la lista de personas
                    break;
                case 5:
                    ...
                    //llamar al metodo buscarPorNombreDeDiscom, el cual retorna persona junto a los datos de persona
                ...
                case 6:
                    ...
                    String titulo = entrada.nextLine();
                    //llamar al metodo buscarPorTituloDeCancion, el cual retorna persona junto a los datos de persona
